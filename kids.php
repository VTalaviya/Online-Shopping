...
<div class="container mt-5 mb-5">
    ...
    <script>
        ...
        $(document).ready(function(){
            main.innerHTML = `<?php getgenderproducts('kids'); ?>`;
        });
        ...
        function getProduct(){
            ...
            {
                main.innerHTML = `<?php getSearchedMenItem('Hoodies','kids') ?>`;
            }
            else if(selected_category === 'T-shirts')
            {
                main.innerHTML = `<?php getSearchedMenItem('T-shirts','kids') ?>`;
            }
            else if(selected_category === 'jeans')
            {
                main.innerHTML = `<?php getSearchedMenItem('jeans','kids') ?>`;
            }
            else if(selected_category === 'Kurta')
            {
                main.innerHTML = `<?php getSearchedMenItem('Kurta','kids') ?>`;
            }
            else if(selected_category === 'Suit')
            {
                main.innerHTML = `<?php getSearchedMenItem('Suit','kids') ?>`;
            }
        }
    </script>
