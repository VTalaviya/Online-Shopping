...
<body>
    ...
    <script>
        ...
        $(document).ready(function(){
            main.innerHTML = `<?php getgenderproducts('Men'); ?>`;
        });
        ...
        function getProduct(){
            ...
            {
                main.innerHTML = `<?php getSearchedMenItem('Hoodies','Men') ?>`;
            }
            else if(selected_category === 'T-shirts')
            {
                main.innerHTML = `<?php getSearchedMenItem('T-shirts','Men') ?>`;
            }
            else if(selected_category === 'jeans')
            {
                main.innerHTML = `<?php getSearchedMenItem('jeans','Men') ?>`;
            }
            else if(selected_category === 'Kurta')
            {
                main.innerHTML = `<?php getSearchedMenItem('Kurta','Men') ?>`;
            }
            else if(selected_category === 'Suit')
            {
                main.innerHTML = `<?php getSearchedMenItem('Suit','Men') ?>`;
            }
        }
    </script>
